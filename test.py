...
def extract_annotated(filename) -> dict[str, pd.DataFrame | datetime.datetime]:
    """High level: extract the melt_curve and amplification_curve dataframes,
...
# print(extract_time_trace('sample_data/05-07-24_RPL27.Qrun', 'ChamberTemperature'))
# print(extract_annotated("sample_data/05-07-24_RPL27.Qrun")["amplification_curve"].groupby(['Well','Name'])['Green'].max())
print(extract_annotated("sample_data/05-07-24_RPL27.Qrun")["amplification_curve"])
# print(extract_annotated("sample_data/05-07-24_RPL27.Qrun")["amplification_curve"]['Name'].unique())

# print(extract_assays("sample_data/05-07-24_RPL27.Qrun"))
